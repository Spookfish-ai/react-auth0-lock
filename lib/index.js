...
var Auth0Lock__default = /*#__PURE__*/_interopDefaultLegacy(Auth0Lock);
...
function AuthConsumer(props) {
    ...
    return React__default['default'].createElement(Consumer, null, function (props) { return children(__assign({}, props)); });
}
...
var AuthProvider = /** @class */ (function (_super) {
    ...
    function AuthProvider(props) {
        ...
        _this.lock = new Auth0Lock__default['default'](props.clientId, props.domain, props.options);
    ...
    AuthProvider.prototype.render = function () {
        ...
        return React__default['default'].createElement(Provider, { value: this.state }, children);
    };
...
function withAuth(Component) {
    return function AuthComponent(props) {
        return (React__default['default'].createElement(Consumer, null, function (auth) { return React__default['default'].createElement(Component, __assign({}, props, { auth: auth })); }));
    };
}

var useAuth = function () { return React.useContext(context); };
